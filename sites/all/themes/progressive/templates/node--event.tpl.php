...
<?php if(!$teaser): ?>
  ...
  <?php endif; ?>
    <div class="event-image">
      <?php print render($content['field_images_events']); ?>
    </div>
    <h2 class = "titolo-evento"><?php print $title; ?></h2>
    ...
    <div class="content clearfix <?php print $classes_array['1']; ?>"<?php print $content_attributes; ?>>
      <?php
        ...
        print render($content['field_eventbritebutton']);
        print render($content);
      ?>
    </div>
  <script src="/sites/all/themes/progressive/js/moment.min.js"></script>
 <script>
   var m = moment();
   m.locale('it');
   var date = '2005-04-03';
   var format = 'LLLL';
   var re =m.subtract(1, 'days').calendar();
